...
const Button = ({ text, icon, color, link, border, hover, rounded }) => {
    ...
    return (
        <Link className={`${color} inline-flex items-center gap-3 w-max pr-3.5 pl-3.5 h-12 ${router === "/website-design-develop-landing" ? "rounded-[100px]" : "rounded-full"} ${hover} ${border}`} href={link}>
